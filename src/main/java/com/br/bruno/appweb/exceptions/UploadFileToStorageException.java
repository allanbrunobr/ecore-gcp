 ...
 */
public class UploadFileToStorageException extends RuntimeException {
   ...
   */
  public UploadFileToStorageException(String message) {
    super(message);
  }
   ...
   */
  public UploadFileToStorageException(String message, Throwable cause) {
    super(message, cause);
  }
}
